...
const INPUT_PW = "w-full pl-9 pr-9 py-2.5 rounded-[8px] border border-border bg-background text-foreground text-[13px] outline-none focus:border-[#ff4615] transition-colors placeholder:text-muted-foreground";
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="w-12 h-12 rounded-[12px] flex items-center justify-center mb-6"
          ...
          <Lock className="size-6" style={{ color: "#ff4615" }} />
        </div>
