...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // Active state: white card in light, themed selected-bg in dark
        ...
        // Inactive + hover
        "text-foreground dark:text-muted-foreground hover:bg-[var(--interactive-hover-bg)] active:bg-[var(--interactive-active-bg)]",
        // Layout
