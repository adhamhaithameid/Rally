import svgPaths from "./svg-j10usiqd9o";
...
function Container14() {
  return (
    <div className="absolute bg-[#232323] content-stretch flex flex-col h-[789px] items-start left-0 overflow-clip right-0 top-0" data-name="Container">
      <Container15 />
    </div>
  );
}
